...
\attribA{ % Autor i lokalizacja cytatu.
  Św. Augustyn \textit{Wyznania}, księga I, 13. \\
...
\attribA{ % Autor i lokalizacja cytatu.
  Św. Augustyn \textit{Wyznania}, księga V, 8 }
% ##################
...
\attribA{ % Autor i lokalizacja cytatu.
  Św. Augustyn \textit{Wyznania}, księga V, 12 }
% ##################
...
\attribA{ % Autor i lokalizacja cytatu.
  Św. Augustyn \textit{Wyznania}, księga VIII, 2 }
% ##################
...
\attribA{ % Autor i lokalizacja cytatu.
  Św. Augustyn \textit{Wyznania}, księga VIII, 8. \\
...
\attribA{ % Autor i lokalizacja cytatu.
  Św. Augustyn \textit{Wyznania}, księga IX, 11. \\
...
\attribA{ % Autor i lokalizacja cytatu.
  Św. Augustyn \textit{Wyznania}, księga X, 1 }
% ##################
...
\attribA{ % Autor i lokalizacja cytatu.
  Św. Augustyn \textit{Wyznania}, księga X, 3 }
% ##################
...
\attribA{ % Autor i lokalizacja cytatu.
  Św. Tomasz z Akwinu, wstęp do \textit{Sumy teologicznej} }
% ##################
...
\attribA{ % Autor i lokalizacja cytatu.
  Św. Tomasz z Akwinu, \textit{Komentarz do Ewangelii Jana},
...
\attribA{Św. Tomasz z Akwinu, \textit{Komentarz do Ewangelii Jana},
...
\attribA{ % Autor i lokalizacja cytatu.
  Św. Tomasz z Akwinu \textit{Komentarz do Ewangelii Jana}, rozdział
...
powiedziano w 1 Kor 3, 17: \textit{Świątynia Boga jest święta, a wy nią
...
samego uznając za mniejszego, Hi~42, 5--6: \textit{Słuchałem ucha

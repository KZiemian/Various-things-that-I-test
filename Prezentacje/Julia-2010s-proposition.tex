...
\begin{frame}
  ...
  \begin{figure}
    ...
    \includegraphics[scale=0.17]{./PresentationPictures/PaddleBattle.png}
...
\begin{frame}
  ...
  author~of \textbf{Channelflow}: \textit{a~set of high-level software
    ...
    geometries} written in~C++, \colorhref{http://channelflow.org/}.
...
\begin{frame}
  ...
  \begin{figure}
    ...
    \includegraphics[scale=0.22]{./PresentationPictures/KSResult.png}
...
\begin{frame}
  ...
  \begin{figure}
    ...
    \includegraphics[scale=0.22]{./PresentationPictures/JFGLinearScale.png}
...
\begin{frame}
  ...
  \begin{figure}
    ...
    {./PresentationPictures/JFGLogarithmScale.png}
...
\begin{frame}
  ...
  \begin{figure}
    ...
    \includegraphics[scale=0.22]{./PresentationPictures/JFGTimeOverCode.png}
...
\begin{frame}
  ...
  \item Picture of Julia creators taken from MIT News page: \colorhref{http://news.mit.edu/2018/julia-language-co-creators-win-james-wilkinson-prize-numerical-software-1226}

...
\begin{frame}
  ...
  \textit{Targeting TPUs using our compiler, we are able to
    ...
    than 1000 lines~of Julia, with no~TPU specific changes made
    to~the~core Julia compiler or~any other Julia packages.}
  Whole article by Keno Fischer
  and Elliot Saba
...
\begin{frame}
  ...
  Arch D. Robison, \textit{Introduction to~Writing High
  ...
  Andy Ferris, \textit{A~practical introduction
...
\begin{frame}
  ...
  Jameson Nash, \textit{AoT or~JIT: How Does Julia Work?},
...
\begin{frame}
  ...
  Carsten Bauer, \emph{Julia for Physics: Quantum Monte
    Carlo}, JuliaCon 2018,
  \colorhref{https://www.youtube.com/watch?v=BmVd7pw6Trc}
  {https://www.youtube.com/watch?v=BmVd7pw6Trc}.
  ...
  Nick Higham, \emph{Tricks and~Tips in~Numerical
    Computing}, JuliaCon 2018,
  \colorhref{https://www.youtube.com/watch?v=Q9OLOqEhc64}
